...
output_directory = 'E:\\Blog\\themes\\butterfly\\source\\img\\iphone\\Recents'

os.makedirs(output_directory, exist_ok=True)
files_to_rename = [f for f in os.listdir(current_directory) if f.startswith('IMG') and os.path.isfile(f)]
